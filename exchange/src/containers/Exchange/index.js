      ...
      <LayoutWrapper style={{padding: 0, height: 'calc(100vh - 120px)'}}>
        <Row style={rowStyle} gutter={16} justify="start">
          <Col md={4} sm={8} xs={24} style={colStyle}>
            <Box title={this.headerBox("Exchange.OrderForm", "ion-ios-list-outline", "#1f2d83")}>
              <OrderForm onFinish={() => this.getOpenOrders()} symbolCode={symbolCode} coinBase={coinBase}
                         coinUsing={coinUsing}/>
            </Box>
          </Col>
          ...
          <Col md={10} sm={8} xs={24} style={colStyle}>
            <Box title={this.headerBox("Exchange.SymbolChart", "ion-ios-list-outline", "#1f2d83")}
                 style={{height: 'calc(50% - 0.6rem)', marginBottom: '0.7rem', textAlign: 'center'}}>
              ...
              <BoxTitle subtitle={"Comming soon"}></BoxTitle>
            </Box>
