    ...
    >
      ...
      >
        {({values, errors, touched, handleSubmit, setFieldValue}) => {
          let oracleNetwork = values.govParams.OracleNetwork || {};
          let sellingBond = values.govParams.SellingBonds || {};
          let sellingGOVTokens = values.govParams.SellingGOVTokens || {};
          return (
                ...
                <div className="row">
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder=""
                      value={oracleNetwork.AcceptableErrorMargin}
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={
                        oracleNetwork.WrongTimesAllowed || ""
                      }
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={oracleNetwork.UpdateFrequency || ""}
                      onChange={e => {
                        setFieldValue(
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={sellingBond.BuyBackPrice || ""}
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={sellingBond.StartSellingAt || ""}
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={sellingBond.SellingWithin || ""}
                      onChange={e => {
                        setFieldValue(
                ...
                <div className="row">
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={sellingGOVTokens.TotalIssue || ""}
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={
                        sellingGOVTokens.GOVTokensToSell || ""
                      }
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={
                        sellingGOVTokens.GOVTokenPrice || ""
                      }
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={
                        sellingGOVTokens.SellingWithin || ""
                      }
                      onChange={e => {
                        setFieldValue(
                  ...
                  <div className="col-12">
                    <TextInputField
                      ...
                      placeholder="0"
                      value={
                        sellingGOVTokens.StartSellingAt || ""
                      }
                      onChange={e => {
                        setFieldValue(
